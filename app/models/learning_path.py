...
from sqlalchemy import Column, Integer, List, String, Text, Boolean, DateTime, func
...
class LearningPath(Base):
    ...
    estimated_duration_days = Mapped[Optional[int]]
    is_active = Mapped[bool] = mapped_column(Boolean, default=True, index=True)
    created_at = Mapped[datetime.datetime] = mapped_column(server_default=func.now())
    updated_at = Mapped[datetime.datetime] = mapped_colum(server_onupdate=func.now())
